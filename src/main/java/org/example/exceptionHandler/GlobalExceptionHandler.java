...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<String > handleTypeNotFoundException(TypeNotPresentException ex){
        return new ResponseEntity<>(ex.getMessage(),HttpStatus.NOT_FOUND);
    }

    @ExceptionHandler(EmptyListExcepption.class)
    public ResponseEntity<String > handleEmptyListExcepption(EmptyListExcepption ex){
        return new ResponseEntity<>(ex.getMessage(), HttpStatus.BAD_REQUEST);
    }
